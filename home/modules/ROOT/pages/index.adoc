...
[.guide]
=== image:logo-kubernetes.png[] xref:kubernetes:ROOT:index.adoc[Hazelcast on Kubernetes]

Getting Started with Hazelcast on Kubernetes.
...
[.guide]
=== image:logo-springboot.png[] xref:spring-session-hazelcast:ROOT:index.adoc[Spring Session Hazelcast]

Getting Started with Spring Session Hazelcast for session replication in Spring Boot.
